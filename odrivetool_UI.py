...
class ExampleApp(QtWidgets.QMainWindow, UI_mainwindow.Ui_MainWindow):
	...
	def update_controller_mode(self):
		...
		print("213123123",axis0_control_mode)
	...
	def axis_control_mode_changed(self, control_mode, axis):
		print(control_mode,"0000000000000000000000000")
		if control_mode == CONTROL_MODE_POSITION_CONTROL: # 位置环
			self.axis_controller_fields_position_enabled(True, axis)
		elif control_mode == CONTROL_MODE_TORQUE_CONTROL: #电流环
			self.axis_controller_fields_position_enabled(False, axis)
		elif control_mode == CONTROL_MODE_VELOCITY_CONTROL: #速度环
			self.axis_controller_fields_position_enabled(False, axis)
	...
	def update_graphs(self):
		delta = time.time() - self.ad["start_time"]
		try:
	...
	def update_velocity_graph(self, axis_key, odrv_axis):
		...
		self.ad[axis_key]["velocity"]["set_point"].append(odrv_axis.controller.input_vel)
	...
	def update_position_graph(self, axis_key, odrv_axis):
		...
		self.ad[axis_key]["position"]["set_point"].append(odrv_axis.controller.input_pos)
...
# 		# ERROR_OVERSPEED = 0x01,
	...
	def scan_can_config(self):
		...
		print("-----------------------")
		print(self.my_drive.can.TxMailboxAbortCallbackCnt)
		print("++++++++++++++++++++++")
	...
	def scan_axis0_controller_config(self):
		self.label_velSetpointValue_axis0.setText(str(self.my_drive.axis0.controller.input_vel))
		self.label_velIntegratorCurrent_axis0.setText(str(self.my_drive.axis0.controller.vel_integrator_current))
		self.label_posSetpointValue_axis0.setText(str(self.my_drive.axis0.controller.input_pos))
		self.label_currentSetpointValue_axis0.setText(str(self.my_drive.axis0.controller.input_torque))
	...
	def scan_axis1_controller_config(self):
		self.label_velSetpointValue_axis1.setText(str(self.my_drive.axis1.controller.input_vel))
		self.label_velIntegratorCurrent_axis1.setText(str(self.my_drive.axis1.controller.vel_integrator_current))
		self.label_posSetpointValue_axis1.setText(str(self.my_drive.axis1.controller.input_pos))
		self.label_currentSetpointValue_axis1.setText(str(self.my_drive.axis1.controller.input_torque))
	...
	def send_axis0_position_go(self):
		print(self.axis0Position_doubleSpinBox.value())
	...
	def send_axis_velocity_current_command(self, axis, mode, value):
		if axis == 0:
			if mode == CONTROL_MODE_TORQUE_CONTROL:# 电流环力矩
				self.my_drive.axis0.controller.input_torque = value
				print("电流环？？？？？？",value)

			elif mode == CONTROL_MODE_VELOCITY_CONTROL: #速度环
				print("速度环？？？？？？",value)
